...
#define MIU_DIG_CNTRL0_REFRESH_OFF	BIT(5)
#define MIU_DIG_CNTRL0_CMD_ISSUE	BIT(8)
#define MIU_DIG_CNTRL0_CMD_WE		BIT(9)
#define MIU_DIG_CNTRL0_CMD_CAS		BIT(10)
#define MIU_DIG_CNTRL0_CMD_RAS		BIT(11)
#define MIU_DIG_CNTRL0_SELF_REFRESH	BIT(13)
#define MIU_DIG_CNTRL0_CMD_DONE		BIT(14)
...
#define MIU_DIG_PROTECTION_STATUS	0x1bc
